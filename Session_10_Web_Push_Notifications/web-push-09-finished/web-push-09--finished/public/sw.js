...
//Reacting to user notification actions, when the user clicks on any actions
self.addEventListener('notificationclick', function(event) {
  var notification = event.notification;
  var action = event.action;

  console.log(notification);
//This is the assigned id for the notification
  if (action === 'confirm') {
...
//We can listen to the close notification event.
